...
router.route("/register").post(
    ...
    router.route("/avatar-update").post(verifyJWT,upload.single("avatar"),updateAvatar);
    router.route("coverImage-update").post(verifyJWT,upload.single("coverImage"),updateCoverImage)
